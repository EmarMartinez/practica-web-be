...
module.exports = new PropertiesController(propertiesService, 'properties', 'id'
  // , {
  ...
  //     }
  //   ],
  //   //* (Optional) Function that returns the final property object that will be sent as response
  //   mapEntity: function (property, req, res) {
  //     //* Your code to map property goes here
  //     return property;
  //   },
