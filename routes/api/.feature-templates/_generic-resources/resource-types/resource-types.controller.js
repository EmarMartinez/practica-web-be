...
const resourceTypesService = require('./resource-types.service');
const { CrudController } = require('@shared/layers/crud.controller');

class ResourceTypesController extends CrudController {

}

module.exports = new ResourceTypesController(resourceTypesService, 'resource-types', 'id'
  // , {
  ...
  //     }
  //   ],
  //   //* (Optional) Function that returns the final resourceType object that will be sent as response
  //   mapEntity: function (resourceType, req, res) {
  //     //* Your code to map resourceType goes here
  //     return resourceType;
  //   },
